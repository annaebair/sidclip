...
class HyperNetTr(nn.Module):
    ...
    def __init__(self, mainnet, embed_dim, text_cfg, hyp_cfg, cast_dtype, init_enc_bias = 1.0, ws=False) -> None:
        ...
        scale = text_cfg.width ** -0.5
        self.class_embedding = nn.Parameter(scale * torch.randn(text_cfg.width))
